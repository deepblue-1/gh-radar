/**
 * Phase 07 — KST 기반 뉴스 날짜 포맷.
 *
 * - 상세 Card: `MM/DD HH:mm` (formatNewsCardDate)
 * - /news 페이지: `YYYY-MM-DD HH:mm` (formatNewsFullDate)
 * - Timezone: `Asia/Seoul` 고정 — 서버는 ISO-8601 UTC 를 내려줌.
