...
| 닿는 곳 | `10.41.1.120` 의 **9100·22** 두 포트뿐(예외: alex-mac `10.20.0.2` 만 `10.41.1.121` 의 9100·22 도 — 프로필 `AllowedIPs` 에 `10.41.1.121/32` 를 더해야 한다). 다른 주소·포트는 VM 이 막는다. 인터넷·사내 자원은 터널을 켠 채로 그대로 쓴다 |
