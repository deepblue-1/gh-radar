...
**Depends on:** Phase 20
**Plans:** 29/36 plans executed (갭 클로징 21-17~21-24 추가 2026-09-26 — 21-UAT.md G-21-1 · G-21-N1~N3 · UAT 3차 갭 클로징 21-25~21-36 추가 2026-09-26 — G-21-R3-1~11 · G-21-CR · 같은 날 과설계 정리로 18→12 플랜 · R3-11 단순안)
...
- [ ] 21-30-PLAN.md — [G-21-R3-8 종목상세] 탭 안 전체목록(NewsFullList · DiscussionFullList · ?view=) · 뒤로가기 네 경로 · 탭 재클릭 = 요약 · 옛 URL 리다이렉트
