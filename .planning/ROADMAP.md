...
- [x] 17-12-PLAN.md — 전량 게이트 green · Playwright 135 pass · D-22 LED 스크린샷 8장(사용자 승인) · 요구사항·로드맵·상태 갱신 (wave 8) — **배포 부분 완료**: push + webapp 프로덕션 반영, **relay 는 권한 거부로 미배포(반쪽 상태)**. D-25 mock 실기 검증은 Xcode 라이선스 게이트로 미수행
