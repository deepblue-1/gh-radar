...
**Depends on:** Phase 20
**Plans:** 30/36 plans executed (갭 클로징 21-17~21-24 추가 2026-09-26 — 21-UAT.md G-21-1 · G-21-N1~N3 · UAT 3차 갭 클로징 21-25~21-36 추가 2026-09-26 — G-21-R3-1~11 · G-21-CR · 같은 날 과설계 정리로 18→12 플랜 · R3-11 단순안)
...
- [ ] 21-31-PLAN.md — [G-21-R3-11 · D-32] 탭 루트 스크롤 복원(useTabRootScrollMemory) · 기존 query-cache 로 스켈레톤 없는 재방문(검색 허브 · 대화 목록 · 오늘 주문)
