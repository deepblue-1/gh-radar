...
Last activity: 2026-09-15 - Completed quick task 260915-h3p: news-sync 수집 주기 재설계 — 장시간 단일 3분 잡(급등 상위 30+관심종목 매회·나머지 3조 순환 9분)·장외 스케줄 분리·일일 한도 소진 중단·CLAUDE.md 공식 API 기준
